        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <div className="glass rounded-xl p-4 border border-white/10">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-semibold text-white">Francesco di Vita</p>
          ...
          <div className="space-y-6 animate-fade-in-up delay-200">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[var(--accent-primary)]/10 border border-[var(--accent-primary)]/30">
              <span className="text-sm font-semibold text-[var(--accent-primary)]">CHI SONO</span>
            </div>
            ...
            <div className="space-y-4 text-lg text-[var(--text-secondary)] leading-relaxed">
              <p>
                24 anni, nato il 18 giugno. Sviluppatore <strong className="text-[var(--text-primary)]">Full-Stack</strong> con 
                una passione per la tecnologia che va oltre il codice.
              </p>
              
              <p>
                Attualmente lavoro per <strong className="text-[var(--text-primary)]">Space2Earth</strong> e <strong className="text-[var(--text-primary)]">GeospatialX</strong>, 
                dove sviluppo soluzioni web e mobile innovative nel settore geospaziale.
              </p>

              <p>
                Il mio approccio combina <strong className="text-[var(--text-primary)]">ambizione</strong>, <strong className="text-[var(--text-primary)]">determinazione</strong> e 
                un costante desiderio di <strong className="text-[var(--text-primary)]">evoluzione</strong>. 
                Credo nel potere del codice pulito e nelle soluzioni che fanno la differenza.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 pt-6">
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-semibold text-[var(--text-primary)]">start2impact University</span>
                </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-semibold text-[var(--text-primary)]">2+ Anni</span>
                </div>
                <p className="text-sm text-[var(--text-muted)] pl-10">
