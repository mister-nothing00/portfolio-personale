        ...
        <div className="container max-w-2xl mx-auto">
          <div className="flex items-center justify-between py-2">
            ...
            <button
              ...
              className="flex flex-col items-center gap-1 px-4 py-2 rounded-xl text-[var(--text-muted)] hover:text-[var(--text-primary)] hover:scale-105 transition-all duration-300"
